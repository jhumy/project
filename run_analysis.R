...
con1 <- file("~/Coursera/UCI HAR Dataset/features.txt",open="r")
#Read the whole features file into a vector named features
...
output_connection <- file("C:/Users/USER/Clean_data/clean_data.txt",open="w")
output_connection2 <- file("C:/Users/USER/Clean_data/clean_data.csv",open="w")
...
output_connection <- file("C:/Users/USER/Clean_data/clean_data2.txt",open="w")
output_connection2 <- file("C:/Users/USER/Clean_data/clean_data2.csv",open="w")
